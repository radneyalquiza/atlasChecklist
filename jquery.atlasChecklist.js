    ...
    */
                ...
                $.each(listA, function () {
                    ...
                    if ($(this).children().length > 1) {
                        ...
                        $(this).children().each(function () {
                            if (!$(this).is('span')) {
                                makeContainer($(this).addClass('sub'));
                            }
                        });
                        ...
                        $(this).click(function (e) {
                            ...
                            if (!$(this).children('.sub').is(':visible')) {
                                $(this).children('.sub').slideDown(200, function () {
    ...
    var methods = {
        ...
        destroy: function (object) {
            ...
            object.data('data').find('*').removeClass('sub');
            object.data('data').find('*').removeClass('listholder');
        ...
        getCheckedData: function (object) {
            var checked = object.children('.checked');
            var checkedwithsubs = object.find('.sub');
            var checkedval = new Array();
            $.each(checked, function () {
                checkedval.push($(this).data($(object).data('defaultDataName')));
            });
            $.each(checkedwithsubs, function () {
                console.log($(this).parent());
                var checkedradio = $(this).find('.checked');
                console.log($(this).data('defaultDataName'));
                console.log(checkedradio);
                checkedval.push(checkedradio.data($(this).data('defaultDataName')));
        ...
        getCheckedDataByName: function (object, dataname) {
            ...
            $.each(checked, function () {
                checkedval.push($(this).data($(object).data(dataname)));
            });
            return checkedval;
        },
